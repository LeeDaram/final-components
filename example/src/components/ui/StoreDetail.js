...
const StoreDetail = () => {
    ...
    const handleReservation = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8080/api/reservation', requestData);
                ...
                <div className="border border-gray-200 p-4 rounded-md space-y-5">
                    ...
                    <div className="flex flex-col gap-2 ">
                        ...
                        <div className="flex">
                            ...
                            {/* 문의버튼 */}
                            <button className="mt-2 px-3 py-1 text-sm bg-blue-500 text-white rounded">문의하기</button>
                        </div>
                        <div className="flex">
                            <GrMoney />
                            <p className="text-sm text-gray-600">
                        ...
                        <div className="flex">
                            <div className="bg-blue-500 text-white rounded text-sm">착한가격</div>
                ...
                <div className="flex gap-4 mt-4 w-full h-1/2">
                    ...
                    {result ? (
                        ...
                        filterCheckboxes
                            ...
                            .map((item) => (
                                <div key={item.name} className="flex flex-col items-start text-sm w-1/2 h-1/2">
                ...
                <div className="w-1/2 flex flex-col items-center">
                    ...
                    <div className="flex mt-2 space-x-2 font-medium">
                        <p className="text-gray-500">
                            전체후기의 <span className="text-blue-500">85%가 긍정적(파이썬)</span>
                        </p>
                    </div>
                </div>
