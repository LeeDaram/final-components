  ...
  const fetchUserApplyInfo = async () => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/mypage/approval/result/${user.id}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
                          ...
                          {tooltipVisible && (
                            ...
                            >
                              ...
                              <p className="text-gray-600 text-sm ">
                                ...
                                촬영해주세요. 좌석 배치, 인테리어, 청결 상태
                                등을 확인할 수 있도록 밝고 선명한 사진을
                                권장합니다.
                              </p>
                              <p className="text-gray-600 text-sm font-semibold pt-3">
                                외부 사진
                              ...
                              <p className="text-gray-600 text-sm ">
                                업소의 간판과 입구가 명확하게 보이도록
                                촬영해주세요. 주변 환경과 위치를 쉽게 파악할 수
                                있도록 정면에서 촬영하는 것이 좋습니다.
                              </p>
                              <p className="text-gray-600 text-sm font-semibold pt-3">
                                파일 형식
                              </p>
