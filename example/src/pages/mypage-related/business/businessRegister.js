...
function BusinessRegister() {
    ...
    const [firstStore, setFirstStroe] = useState('');
    ...
    const fetchUserInfo = async () => {
        try {
            ...
            if (storeData) {
                setFirstStroe(storeData.finalApprovalStatus);
            }
    ...
    const createGpb = async () => {
        try {
            ...
            // 승인관리 업로드
            await axios.put(`${process.env.REACT_APP_API_URL}/bizimg/update/approval`, body);
                        ...
                        {firstStore != 'APPROVED' && firstStore != 'PENDING' && firstStore != '' ? (
                            <>
                                ...
                                <div className="mb-3">
                                            ...
                                            {tooltipVisible && (
                                                ...
                                                >
                                                    ...
                                                    <p className="text-gray-600 text-sm ">
                                                        ...
                                                        인테리어, 청결 상태 등을 확인할 수 있도록 밝고 선명한 사진을
                                                        권장합니다.
                                                    </p>
                                                    <p className="text-gray-600 text-sm font-semibold pt-3">
                                                        외부 사진
                                                    ...
                                                    <p className="text-gray-600 text-sm ">
                                                        업소의 간판과 입구가 명확하게 보이도록 촬영해주세요. 주변 환경과
                                                        위치를 쉽게 파악할 수 있도록 정면에서 촬영하는 것이 좋습니다.
                                                    </p>
                                                    <p className="text-gray-600 text-sm font-semibold pt-3">
                                                        파일 형식
                                                    </p>
                                    ...
                                    {!isUploaded && (
                                        <>
                                            ...
                                            <span className="label">
                                                {formErrors.file && (
                                                    <span className="text-red-500">{formErrors.file}</span>
                                                )}
                                            </span>
                                        </>
                                    )}
                                    ...
                                    {isUploaded && (
                                        ...
                                        >
                                            ...
                                            <p>
                                                <span className="text-lg font-semibold">파일 업로드 성공 : </span> AI가
                                                이미지를 인식할거예요.
                                            </p>
                                            <img
                                                id="face-image"
                                ...
                                <div className="relative mb-3">
                                    ...
                                    <span className="label">
                                        {formErrors.userSido && (
                                            <span className="text-red-500">{formErrors.userSido}</span>
                                        )}
                                    </span>
                                </div>
                                ...
                                <div className="flex gap-5 mb-5">
                                    ...
                                    <div className="flex flex-col flex-1">
                                        ...
                                        <span className="label">
                                            {formErrors.userMenu && (
                                                <span className="text-red-500">{formErrors.userMenu}</span>
                                            )}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="relative mb-3">
                                    ...
                                    <span className="label">
                                        {formErrors.userPrice && (
                                            <span className="text-red-500">{formErrors.userPrice}</span>
                                        )}
                                    </span>
                                    {priceMessage && (
                                        <div
                                ...
                                <div className="relative mb-3">
                                    ...
                                    <div className="flex gap-3 flex-wrap">
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <label className="label label-text text-base" htmlFor="facilityParking">
                                                주차
                                            </label>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <label className="label label-text text-base" htmlFor="facilityTakeout">
                                                포장
                                            </label>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <label className="label label-text text-base" htmlFor="facilityDelivery">
                                                배달
                                            </label>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <label className="label label-text text-base" htmlFor="facilityWifi">
                                                와이파이
                                            </label>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <label className="label label-text text-base" htmlFor="facilityPet">
                                                반려동물
                                            </label>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <label className="label label-text text-base" htmlFor="facilityKids">
                                                유아시설
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div className="alert alert-soft alert-error flex items-start gap-4">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className="mt-1.5 list-inside list-disc">
                                        현재 귀하의 업소는 착한가격업소에 신청한 이력이 있습니다. 등록신청 결과를
                                        확인해주세요.
                                    </p>
                                </div>
                            </div>
