...
function BusinessRegister() {
    ...
    const fetchUserInfo = async () => {
        try {
            const regionResponse = await fetch(`http://localhost:8080/api/location/${user.id}`, {
                method: 'GET',
                headers: {
    ...
    // 유저 정보 가져오기2 : 이미 신청한 적 있나 해서
    const fetchUserApplyInfo = async () => {
        try {
                        ...
                        {approvalResult?.finalApprovalStatus != 'APPROVED' ? (
                                    ...
                                    <div class="alert alert-soft alert-error flex items-start gap-4">
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <p class="mt-1.5 list-inside list-disc">
                                                착한가격업소 등록 신청한 내역이 없습니다. 우선 착한가격업소 등록 신청을
                                                해주세요.
                                            </p>
                                        </div>
                                    </div>
                                                    ...
                                                    {tooltipVisible && (
                                                        ...
                                                        >
                                                            ...
                                                            <p className="text-gray-600 text-sm ">
                                                                매장의 전체적인 내부 모습이 잘 보이도록 촬영해주세요.
                                                                좌석 배치, 인테리어, 청결 상태 등을 확인할 수 있도록
                                                                밝고 선명한 사진을 권장합니다.
                                                            </p>
                                                            <p className="text-gray-600 text-sm font-semibold pt-3">
                                                                외부 사진
                            ...
                            <>
                                <div class="alert alert-soft alert-error flex items-start gap-4">
                                    <span class="icon-[tabler--info-circle] size-6"></span>
                                    <div class="flex flex-col gap-1">
                                        <h5 class="text-lg font-semibold">이미 착한가격업소 입니다</h5>
                                        <p class="mt-1.5 list-inside list-disc">
                                            현재 귀하의 업소는 착한가격업소입니다.
                                        </p>
                                    </div>
                                </div>
                            </>
