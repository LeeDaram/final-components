...
function ApplyStatus() {
    ...
    const fetchUserInfo = async () => {
        try {
            const response = await fetch(`http://localhost:8080/api/mypage/approval/result/${userId}`, {
                method: 'GET',
                headers: {
                    ...
                    <div className="w-3/4 pl-10 pt-10 border-l border-gray-200 ">
                        ...
                        <div className="rounded-lg border-gray-200 border p-10">
                            <div className="mb-6">
                                ...
                                <p className="block text-lg font-semibold mb-1">{approvalResult?.storeName || ''}</p>
                            </div>
                            {/* 등록신청일자 */}
                            <div className="mb-6">
                                <label className="text-gray-500">등록 신청 일자</label>
                                <p className="block text-lg font-semibold mb-1">{approvalResult?.updatedAt || ''}</p>
                            </div>
                            {/* 심사결과 */}
                            <div className="mb-6">
